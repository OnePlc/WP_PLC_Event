...
class WPPLC_Event_Compactlist extends \Elementor\Widget_Base {
    public function __construct($data = [], $args = null) {
        parent::__construct($data, $args);
    }

    public function get_name() {
        return 'wpplceventcompactlist';
    }

    public function get_title() {
        return __('Compact List', 'wp-plc-event');
    }
    ...
    protected function render() {
        ...
        if(is_numeric($aSettings['compactlist_filter_category'])) {
            $aParams['filter'] = '["onlycurrent","category"]';
            $aParams['filtervalue'] = '["date_start","'.(int)$aSettings['compactlist_filter_category'].'"]';
        }
        ...
        if ($oAPIResponse->state == 'success') {
            ...
            require WPPLC_EVENT_PLUGIN_MAIN_DIR.'/includes/view/partial/widget_compactlist.php';
        } else {
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .plc-calendar-list-date, {{WRAPPER}} .plc-calendar-list-widget-title, {{WRAPPER}} .plc-calendar-list-img, {{WRAPPER}} .plc-calendar-list-item' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
