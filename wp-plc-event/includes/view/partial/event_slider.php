            ...
            <div class="swiper-slide">
                <div style="display: inline-block; width:100%;">
                    ...
                    <figure class="plc-slider-image-box-img" style="width:100%; margin-bottom: <?=$aSettings['slider_item_spacer']['size'].$aSettings['slider_item_spacer']['unit']?>;">
                        <a href="#<?=$oItem->id?>" class="plc-shop-event-popup" title="Mehr Informationen">
                            <div style="height:200px; width:100%; min-width:100%; background:url(<?=$sHost?><?=$oItem->featured_image?>) no-repeat 100% 0%; background-size:cover;">
                                &nbsp;
                            </div>
                        </a>
                    </figure>
                    ...
                    <?php if($aSettings['slider_slide_show_date'] == 'yes') { ?>
                        <!-- Date -->
                        <div class="plc-slider-slide-date" style="height:<?=$aSettings['slider_slide_date_height']?>; position: relative; overflow:hidden; vertical-align: middle; text-align:<?=$aSettings['slider_slide_date_align']?>;">
                            <?= utf8_encode(strftime('%A, %d. %B %Y', strtotime($oItem->date_start))) ?>
                        </div>
                        <!-- Date -->
                    <?php } ?>
                    ...
                    <div class="plc-slider-slide-content" style="width:100%; text-align:center; margin-top:<?=$aSettings['slider_item_spacer']['size'].$aSettings['slider_item_spacer']['unit']?>; margin-bottom:<?=$aSettings['slider_item_spacer']['size'].$aSettings['slider_item_spacer']['unit']?>; min-height:200px;">
                        ...
                        <?php if($aSettings['slider_slide_show_title_hr'] == 'yes') { ?>
                            <hr class="plc-slider-slide-title-divider" />
                        <?php } ?>
                        <!-- Title -->
                        <?php } ?>

                        <?php if($aSettings['slider_slide_show_excerpt'] == 'yes') { ?>
                            <!-- Excerpt -->
                            <div class="plc-slider-slide-excerpt" style="height:<?=$aSettings['slider_slide_excerpt_height']?>; position: relative; overflow:hidden; vertical-align: middle; text-align:<?=$aSettings['slider_slide_excerpt_align']?>;">
                                <?= $oItem->excerpt ?>
                            </div>
                            <!-- Excerpt -->
                        <?php } ?>
                        ...
                        <?php if($aSettings['slider_slide_show_price'] == 'yes') {
                            ...
                            <?php } elseif(isset($oItem->price_sell)) { ?>
                                <select class="plc-slider-slide-price" plc-item-type="event">
                    ...
                    <div style="width:100%; display: inline-block;">
                        <?php if($aSettings['slider_slide_show_button_buy'] == 'yes') { ?>
                            <div style="width:50%; float:left;">
                                ...
                                <a href="#<?=$oItem->id?>" class="<?=$sBuyCls?> plc-slider-button" plc-item-type="<?=(isset($oItem->variants)) ? 'variant' : 'event'?>" style="display:inline-block; width:<?=$aSettings['buttons_slide_width']?>;">
                        ...
                        <?php if($aSettings['slider_slide_show_button_gift'] == 'yes') { ?>
                            <div style="width:50%; float:left; padding-left:<?=$aSettings['slider_item_spacer']['size'].$aSettings['slider_item_spacer']['unit']?>;">
                                <!-- Gift Button -->
                                <a href="#<?=$oItem->id?>" class="plc-shop-giftitem-tobasket plc-slider-button" plc-item-type="<?=(isset($oItem->variants)) ? 'variant' : 'event'?>" style="display:inline-block; width:<?=$aSettings['buttons_slide_width']?>;">
